...
<html lang="pt-br">
  ...
  <body>
    <div class="card">
      ...
      <p>Algo correu mal da nossa parte. Pode tentar atualizar ou voltar à página inicial.</p>
      <div class="actions">
...
async function getServerEntry() {
  if (!serverEntryPromise) {
    serverEntryPromise = import("./assets/server-BL1UR38g.js").then((n) => n.s).then(
      (m) => m.default ?? m
    );
  }
