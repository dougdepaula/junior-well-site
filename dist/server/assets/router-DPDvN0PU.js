import { Q as reactExports, E as isPromise, F as isRedirect, C as isNotFound, y as invariant, f as createControlledPromise, _ as rootRouteId, G as isServer$1, t as functionalUpdate$1, a as arraysEqual, g as createLRUCache, d as compileDecodeCharMap, a0 as trimPath, Z as rewriteBasepath, e as composeRewrites, P as processRouteTree, N as processRouteMasks, Y as resolvePath, c as cleanPath, a2 as trimPathRight, M as parseHref, o as executeRewriteInput, z as isDangerousProtocol, S as redirect, s as findSingleMatch, j as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, b as buildRouteBranch, x as interpolatePath, L as nullReplaceEqualDeep, U as replaceEqualDeep$1, J as last, i as decodePath, q as findFlatMatch, r as findRouteMatch, w as hasKeys, p as executeRewriteOutput, l as encodePathLikeUrl, a1 as trimPathLeft, H as joinPaths, a4 as useRouter, k as dummyMatchContext, K as matchContext, v as getDefaultExportFromCjs, W as requireReactDom, n as exactPathTest, T as removeTrailingSlash, R as React, I as jsxRuntimeExports, B as isModuleNotFoundError, a3 as useHydrated, m as escapeHtml, A as isInlinableStylesheet, u as getAssetCrossOrigin, X as resolveManifestAssetLink, O as Outlet } from "./server-C1yYFg7k.js";
...
const appCss = "/assets/styles-C_W7TXLD.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Elite Foundry is a high-ticket digital repositioning application for a personal trainer." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Elite Foundry is a high-ticket digital repositioning application for a personal trainer." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Elite Foundry is a high-ticket digital repositioning application for a personal trainer." }
    ],
    links: [
...
function RootShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "en", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("body", { children: [
      children,
      /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, { position: "bottom-right", theme: "dark", richColors: true }),
...
const $$splitComponentImporter = () => import("./index-CoEabYvQ.js");
const Route2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component"),
  head: () => ({
    meta: [{
      title: "Junior Well — Treino de Elite, Ciência & Longevidade"
    }, {
      name: "description",
      content: "Consultoria de treino high-ticket: biomecânica, reabilitação e hipertrofia de precisão. Ciência aplicada ao corpo real."
    }, {
      property: "og:title",
      content: "Junior Well — Treino de Elite"
    }, {
      property: "og:description",
      content: "Ciência aplicada ao corpo real. Sem promessas falsas, apenas método."
    }]
  })
});
